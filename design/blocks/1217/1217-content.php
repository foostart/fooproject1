        ...
        <div class="row">
            <div class="contact_us">
                <div class="contact_title"> 
                    ...
                    <div class="content_sub">The information you leave behind and the content of the message will be kept confidential. Please be sure to leave your contact details to ensure that our reply can be provided for your reference.</div>
                </div>
                <!--Form Information-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 padding-20">
                                <select class="select" name="select_name">
                                    <option value="#" class="selected_disable" selected="true" disabled="disabled">Gender</option>
                            ...
                            <div class="col-md-4 col-sm-6 padding-20">
                                <select class="select" name="select_name">
                                    <option value="#" class="selected_disable" selected="true" disabled="disabled">Space category</option>
                            ...
                            <div class="col-md-4 col-sm-6 padding-20">
                                <select class="select" name="select_name">
                                    <option value="#" class="selected_disable" selected="true" disabled="disabled">Family member</option>
                            ...
                            <div class="col-md-4 col-sm-6 padding-20">
                                <select class="select" name="select_name">
                                    <option value="#" class="selected_disable" selected="true" disabled="disabled">Custom budget</option>
                            ...
                            <div class="typehouse col-md-12 col-sm-12">
                                ...
                                <div class="col-md-3 col-sm-6 padding-20">
                                    <select class="select" name="select_detail">
                                        <option value="#" class="selected_disable" selected="true" disabled="disabled">Ping number</option>
                                ...
                                <div class="col-md-3 col-sm-6 padding-20">
                                    <select class="select" name="select_detail">
                                        <option value="#" class="selected_disable" selected="true" disabled="disabled">Number of rooms</option>
                                ...
                                <div class="col-md-3 col-sm-6 padding-20">
                                    <select class="select" name="select_detail">
                                        <option value="#" class="selected_disable" selected="true" disabled="disabled">Number of halls</option>
                                ...
                                <div class="col-md-3 col-sm-6 padding-20">
                                    <select class="select" name="select_detail">
                                        <option value="#" class="selected_disable" selected="true" disabled="disabled">Wei number</option>
